...
$sql2 = "SELECT Message_ID, Message, Send_TIME, First_name, Last_name FROM chat INNER JOIN users ON users.User_id = chat.User_ID WHERE Group_ID = $groupid ORDER BY Message_ID ASC";
